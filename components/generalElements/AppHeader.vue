  ...
  <header class="sticky top-0 z-40 bg-white shadow-sm shadow-light-500">
    <div class="container flex items-center justify-between py-4">
      <div class="flex items-center">
        ...
        <Logo class="md:w-[300px]" />
      </div>
      <MainMenu class="items-center hidden gap-6 font-sans text-base text-gray-500 lg:flex lg:px-4 hover:[&>*]:bg-gray-100 [&>*]:px-4 [&>*]:py-2 [&>*]:rounded-xl" />
